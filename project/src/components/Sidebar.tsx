...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      {/* Sidebar */}
      <aside className={`fixed left-0 top-0 h-screen z-40 flex flex-col bg-theme-bg-secondary shadow-xl border-r border-theme-border-primary transition-all duration-200 overflow-visible ${isExpanded ? 'w-80' : 'w-20'}`}>
        {/* Header */}
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative group w-full">
                ...
                {/* Tooltip - positioned outside button for better hover detection */}
                {!isExpanded && (
                  <div className="absolute left-full top-1/2 -translate-y-1/2 ml-3 z-[10000] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-200 ease-out">
                    <div className="relative">
