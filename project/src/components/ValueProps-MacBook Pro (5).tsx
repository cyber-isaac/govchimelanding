        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-900 text-lg max-w-2xl mx-auto">
              Powerful tools designed specifically for federal contractors to discover, analyze, and win more contracts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              <motion.article
                ...
                className="rounded-2xl border border-white/10 bg-neutral-800 p-6 shadow-lg group max-w-md w-full mx-auto"
              >
                ...
                <p className="text-sm leading-6 text-neutral-200 mb-4">
                  {feature.description}
                </p>

                <ul className="space-y-2">
                  {feature.bullets.map((bullet, bulletIndex) => (
                    <li key={bulletIndex} className="flex items-start gap-3 text-sm text-neutral-100">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-blue-600/30 p-12 bg-white shadow-xl">
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-900 mb-8 max-w-2xl mx-auto">
                Join 500+ federal contractors who are already winning with GovChime
              </p>
