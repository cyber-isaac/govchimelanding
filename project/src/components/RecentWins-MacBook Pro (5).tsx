...
const RecentWins: React.FC = () => {
  const recentWins = [
    ...
    },
    {
      ...
      naics: '541513',
      naicsDescription: 'Computer Facilities Management',
      setAside: 'WOSB',
      color: 'text-pink-300'
    },
    {
    ...
    },
    {
      ...
      location: 'Houston, TX',
      naics: '237120',
      naicsDescription: 'Oil and Gas Pipeline Construction',
      setAside: 'UNRESTRICTED',
      color: 'text-gray-300'
    }
  ];
  ...
  const getSetAsideBadge = (setAside: string) => {
    ...
    switch (setAside) {
      ...
      case 'SDVOSB':
        return `${baseClasses} bg-green-400/10 text-green-300 border-green-400/20`;
      case 'WOSB':
        return `${baseClasses} bg-pink-400/10 text-pink-300 border-pink-400/20`;
      case 'HUBZone':
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="flex justify-center items-center gap-2 mb-8">
            <div className="flex backdrop-blur-lg rounded-2xl p-2 dark:bg-white/5 dark:border-white/10 bg-white/90 border border-gray-300 shadow-lg">
              <button className="px-6 py-3 bg-blue-500 text-white rounded-xl font-semibold transition-all duration-200 hover:bg-blue-400">
                All
              </button>
              <button className="px-6 py-3 rounded-xl font-semibold transition-all duration-200 dark:text-gray-300 dark:hover:text-white dark:hover:bg-white/10 text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                IT
              </button>
              <button className="px-6 py-3 rounded-xl font-semibold transition-all duration-200 dark:text-gray-300 dark:hover:text-white dark:hover:bg-white/10 text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                Construction
  ...
  <div className="relative max-w-7xl mx-auto">
    <div className="overflow-x-auto scrollbar-hide pb-4">
      ...
      <div className="flex gap-4 px-4 min-w-0" style={{ width: 'max-content' }}>
        {recentWins.slice(0, 6).map((win, index) => (
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm dark:text-gray-400 text-gray-600">
                See {recentWins.length - 6} more recent awards
              </p>
      ...
      <div className="flex justify-center mt-4 space-x-2">
        ...
        <div className="w-2 h-2 rounded-full bg-blue-400 opacity-30"></div>
