...
const NewsSignals: React.FC = () => {
  ...
  const socialPosts = [
    {
      handle: '@SBAgov',
      content: '🚀 New HUBZone map updates now live! Check if your business qualifies for expanded opportunities...',
      time: '3 hours ago',
      platform: 'Twitter',
      icon: '𝕏',
    ...
    {
      handle: '@USASpending',
      content: 'FY24 Q4 spending data now available. Federal agencies obligated $1.7T in contracts and grants...',
      time: '6 hours ago',
      platform: 'LinkedIn',
      icon: 'in',
    ...
    },
    {
      ...
      content: 'DOD announces strategic partnership with industry for next-gen AI capabilities in defense systems...',
      time: '1 day ago',
      platform: 'Facebook',
      icon: 'f',
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`w-10 h-10 rounded-lg ${post.iconBg} flex items-center justify-center flex-shrink-0 shadow-sm`}>
                      <span className={`text-sm font-bold ${post.iconColor}`}>
                        {post.icon}
                      </span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs px-2 py-1 rounded-full bg-gray-200 dark:bg-gray-700 dark:text-gray-300 text-gray-600">
                          {post.platform}
                        </span>
